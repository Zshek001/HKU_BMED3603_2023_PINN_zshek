...
class Parser(argparse.ArgumentParser):
    def __init__(self):
        ...
        # data
        self.add_argument('--frame', type=int, default=1, help="specific frame to train")

        
        # training
        self.add_argument('--epochs', type=int, default=1500, help='number of epochs to train')
        ...
        self.add_argument('--batch_size', type=int, default=128, help='batch size for training')
